...
lst = []
for i in input_str:
    lst_num = re.findall('\d+', i )
    num_str = "".join(lst_num)
    lst.append(int(num_str[0] + num_str[-1]))
...
input_str_modified = []
for i in input_str:
    input_str_modified.append(multiple_replace(replacement_dict,i))
# %%

lst_num_modified = []
for j in input_str_modified:
    lst_num = re.findall('\d+', j )
    num_str = "".join(lst_num)
    lst_num_modified.append(int(num_str[0] + num_str[-1]))
# %%
sum(lst_num_modified)
# %%

##########################

def multiple_replace2(text):
...
input_str_modified = []
for i in input_str:
    input_str_modified.append(multiple_replace2(i))
